...
import { Card, Button, Form, Icon, Col, Row, DatePicker, TimePicker, Input, Select, Popover, message, Menu, Dropdown, Popconfirm } from 'antd';
...
export default connect(({ global, user, loading }) => ({
  ...
  user,
  logouting: loading.effects['user/logout'],
